...
function LikedSongs() {
  ...
  return (
    <div className="min-h-screen w-full bg-stone-900 flex flex-col ">
      <div className="p-12  bg-gradient-to-b from-[#604EC1] to-[#121212] rounded-lg shadow-lg flex-grow">
        ...
        <div className="flex items-end gap-6">
          ...
          <h2 className="text-[50px] sm:text-[85px] max-w-[659px] font-bold mb-4 text-white">
            Liked Songs
          </h2>
        </div>
